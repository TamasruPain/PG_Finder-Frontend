...
const ListOfUsers = () => {
  ...
  useEffect(() => {
    axios.get('https://pg-finder-backend.onrender.com/api/user/users')
      .then(result => {
  ...
  const handleDelete = (id) => {
    ...
    if (isConfirmed) {
      axios.delete('https://pg-finder-backend.onrender.com/api/user/users/' + id)
        .then(res => {
          console.log(res);
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await fetch(`https://pg-finder-backend.onrender.com/api/user/profile/${userId}`, {
        method: 'PATCH',
        headers: {
