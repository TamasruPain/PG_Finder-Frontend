...
const CustomerQueries = () => {
  ...
  useEffect(() => {
    axios.get('https://pg-finder-backend.onrender.com/api/properties')
      .then(result => setProperties(result.data))
      .catch(err => console.log(err));
  }, []);

  useEffect(() => {
    axios.get('https://pg-finder-backend.onrender.com/api/query')
      .then(result => {
  ...
  const handleDelete = (id) => {
    ...
    if (isConfirmed) {
      axios.delete('https://pg-finder-backend.onrender.com/api/query/' + id)
        .then(res => {
          console.log(res);
