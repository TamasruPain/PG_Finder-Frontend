...
const PropViewForm = () => {
    ...
    useEffect(() => {
        axios.get('https://pg-finder-backend.onrender.com/api/properties/' + id)
            .then(result => {
                console.log(result);
    ...
    const handleDelete = async (id) => {
        ...
        if (isConfirmed) {
            try {
                const response = await axios.delete(`https://pg-finder-backend.onrender.com/api/properties/${id}`);
